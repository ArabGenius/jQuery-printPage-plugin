 ...
 * @Updater: Ahmed AlMaskari, http://www.abqariservice.com
 * @licence: MIT
...
(function( $ ){
  $.fn.printPage = function(options) {
    ...
    this.on("click",null, function(){  loadPrintDocument(this, pluginOptions); return false;  });
    ...
    function unloadMessage(){
      $("#printMessageBox").delay(500).animate({opacity:0}, 400, function(){
        $(this).remove();
      });
    }
    /*
